...
fun HomeScreen(
    ...
    Scaffold(topBar = { HomeScreenTopBar() },
        ...
        Column {
            Text(
                text = "Good afternoon, Ravin!", style = TextStyle(
                    fontSize = 32.sp,
            ...
            Row {
                Column(
                    ...
                    Text(
                        text = "Rp$balance", style = TextStyle(
                    ...
                    TextButton(
                        ...
                        Text(text = "Top up", modifier = Modifier.padding(horizontal = 6.dp))
                    }
                }
...
fun HomeScreenFAB(
    ...
    ExtendedFloatingActionButton(
        text = { Text(text = "Rp$balance on card", fontSize = 26.sp) },
        onClick = { },
        shape = RoundedCornerShape(100.dp),
        backgroundColor = Color(0xff3b8551),
        contentColor = Color.White,
